...
const MobileMenu: FC<MobileMenuProps> = ({isOpen, onClose}) => {
    ...
    return (
        <div
            className={`mobile-menu ${isOpen ? 'mobile-menu_open' : ''}`}
        >
            <div className="mobile-menu__content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="mobile-menu__profile">
                    <DefaultAvatar />
                    <h2 className="mobile-menu__profile_h2">Профиль</h2>
                </div>
                <ul className="mobile-menu__list">
                    ...
                    <li>
                        <Link className="mobile-menu__list_a" to="/login">
                            Мой профиль
                        </Link>
                    </li>
                    <li>
                ...
                <div className="mobile-menu__theme-switch">
                    <p className="mobile-menu__theme-switch__p"> {currentTheme === 'dark' ? 'Тёмная' : 'Светлая'} тема</p>
                    <ThemeSwitcher/>
                </div>
            </div>
        </div>
